...
if (isset($_POST['submit'])) {
  ...
  $PubDBQuerries -> updateDebtUsername($username, -$value);
  ...
  <tr><td colspan=2><h2>Debt credit</h2></td></tr>
  <tr><td>Username:</td><td> <input type="text" name="username" required maxlength="40"></td></tr>
  <tr><td>Amount:</td><td>   <input type="number" required name="value" maxlength="10"></td></tr>
